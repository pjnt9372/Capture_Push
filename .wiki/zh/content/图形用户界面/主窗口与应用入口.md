...
SchoolMod["core/plugins/plugin_manager.py<br/>插件管理器"]
...
- [core/plugins/plugin_manager.py](file://core/plugins/plugin_manager.py#L22-L28)
...
Entry->>Win : show()
Win->>Log : 获取配置/日志路径
Win->>Plugins : 获取可用院校/加载插件
User->>Win : 点击“查看成绩”
Win->>SubG : 打开成绩窗口
SubG->>Core : 子进程调用 --fetch-grade --force
Core->>Plugins : 解析 HTML/抓取数据
Core->>Log : 写入状态/日志
User->>Win : 点击“查看课表”
Win->>SubS : 打开课表窗口
