...
I["core/plugins/plugin_manager.py<br/>院校插件发现"]
J["core/plugins/12345/__init__.py<br/>院校适配器"]
K["core/plugins/12345/getCourseSchedule.py<br/>课表抓取/解析"]
L["core/plugins/12345/getCourseGrades.py<br/>成绩抓取/解析"]
end
A --> B
B --> C
B --> D
