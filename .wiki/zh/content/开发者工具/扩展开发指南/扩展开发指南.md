...
- [PLUGIN_FLOW_CHART.md](file://PLUGIN_FLOW_CHART.md)
- [12345/__init__.py](file://core/plugins/12345/__init__.py)
- [10546/__init__.py](file://developer_space/10546/__init__.py)
...
- GUI 模块
  ...
  - gui/gui.py：主应用入口
- 开发者工具
  - developer_tools/EXTENSION_GUIDE.md：扩展开发指南
  - developer_tools/build_plugin.py：插件构建工具，用于创建和发布插件
  - developer_tools/register_or_undo.py：注册表路径管理工具
- 配置与依赖
  - config.ini：应用配置文件
  - plugins_index.json：插件索引文件，包含可用插件的元数据
...
subgraph "开发者工具"
EXTGUIDE["扩展指南<br/>developer_tools/EXTENSION_GUIDE.md"]
BUILDTOOL["插件构建工具<br/>developer_tools/build_plugin.py"]
REGTOOL["注册表工具<br/>developer_tools/register_or_undo.py"]
end
CFGWIN --> PUSH
PLUGIN_TAB --> PLUGINS
PUSH --> SENDERS
...
**章节来源**
- [EXTENSION_GUIDE.md](file://developer_tools/EXTENSION_GUIDE.md#L7-L84)
...
- 插件结构与必需文件
  - 在 developer_space/[学校代码]/ 下创建插件目录
  - 在该目录下创建以下文件：
...
- 插件发布与管理
  - 使用 developer_tools/build_plugin.py 构建插件包
  - 自动计算 SHA256 校验和并生成版本号
  - 通过 GitHub Releases 发布插件包
  - 系统自动更新 plugins_index.json 索引文件
...
- [10546/__init__.py](file://developer_space/10546/__init__.py#L6-L14)

**章节来源**
- [EXTENSION_GUIDE.md](file://developer_tools/EXTENSION_GUIDE.md#L122-L317)
...
**章节来源**
- [EXTENSION_GUIDE.md](file://developer_tools/EXTENSION_GUIDE.md#L321-L339)
- [config_manager.py](file://core/config_manager.py#L15-L68)
...
**章节来源**
- [requirements.txt](file://requirements.txt#L1-L3)
- [EXTENSION_GUIDE.md](file://developer_tools/EXTENSION_GUIDE.md#L335-L339)
...
## 附录
- 开发者工具
  - 扩展开发指南：developer_tools/EXTENSION_GUIDE.md
  - 插件构建工具：developer_tools/build_plugin.py
  - GUI 模块化设计：gui/GUI_MODULAR_DESIGN.md
  - 注册表路径管理：developer_tools/register_or_undo.py
- 配置参考
...
- 插件开发参考
  - 插件索引文件：plugins_index.json
  - 插件构建流程：PLUGIN_FLOW_CHART.md
  - 示例插件：core/plugins/12345/
  - 开发示例：developer_space/10546/